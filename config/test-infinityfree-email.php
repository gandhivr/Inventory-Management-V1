<?php
/**
 * Email Configuration for InfinityFree Hosting
 * InfinityFree blocks external SMTP, so we use their built-in mail system
 */

// Email configuration
define('EMAIL_FROM', 'noreply@prostock.free.nf'); // Use your domain
define('EMAIL_FROM_NAME', 'Inventory Management System');
define('EMAIL_REPLY_TO', 'vrajgandhi06@gmail.com'); // Your actual email for replies

/**
 * Send email using InfinityFree's mail system
 */
function sendEmail($to, $subject, $message, $headers = []) {
    ...
    // For InfinityFree production - use PHP mail()
    try {
        // Create proper email headers for InfinityFree
        $email_headers = "MIME-Version: 1.0\r\n";
        $email_headers .= "Content-type: text/html; charset=UTF-8\r\n";
        $email_headers .= "From: " . EMAIL_FROM_NAME . " <" . EMAIL_FROM . ">\r\n";
        $email_headers .= "Reply-To: " . EMAIL_REPLY_TO . "\r\n";
        $email_headers .= "X-Mailer: PHP/" . phpversion() . "\r\n";
        
        // InfinityFree requires the 5th parameter to be set
        $additional_params = "-f" . EMAIL_FROM;
